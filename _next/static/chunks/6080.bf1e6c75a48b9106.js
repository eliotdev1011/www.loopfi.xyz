      ...
      (t.fetchRPCRequest = i),
        ...
        (t.getCoinbaseInjectedProvider = function ({
          ...
          if ("smartWalletOnly" !== t.options) {
            if (a()) return;
            let t = i.coinbaseWalletExtension;
            if (t) {
          ...
          let o =
            null !== (s = i.ethereum) && void 0 !== s
              ? s
              : null === (n = i.top) || void 0 === n
              ? void 0
              : n.ethereum;
          if (null == o ? void 0 : o.isCoinbaseBrowser) return o;
        }),
      ...
      function u(e, t) {
        ...
        for (var r, o, d = [], l = 0; l < e.length; l++) {
          var u = i(e[l]),
            h = t[l];
          if ("bytes" === u) d.push(h);
          else if ("string" === u) d.push(new s(h, "utf8"));
          else if ("bool" === u) d.push(new s(h ? "01" : "00", "hex"));
          else if ("address" === u) d.push(n.setLength(h, 20));
          else if (u.startsWith("bytes")) {
            if ((r = a(u)) < 1 || r > 32)
              throw Error("Invalid bytes<N> width: " + r);
            d.push(n.setLengthRight(h, r));
